...
final _mockArticles = [
  Article(
    ...
    publicationDate: DateTime.parse('2024-03-01'),
    imageUrl: 'https://www.meme-arsenal.com/memes/e0908be8b4e72c9bc7294e2a5d7468ee.jpg',
...
To continue to enjoy ForestVPN without interruptions, please upgrade to our Premium version.''',
  ...
  Article(
    ...
    publicationDate: DateTime.parse('2024-04-29'),
